...
impl Convert<usize> for f64 {
    fn convert(x: usize) -> Self { x as f64 }
}

impl Convert<u8> for f64 {
    fn convert(x: u8) -> Self { f64::from(x) }
}
impl Convert<u16> for f64 {
    fn convert(x: u16) -> Self { f64::from(x) }
}
impl Convert<i32> for f64 {
    fn convert(x: i32) -> Self { f64::from(x) }
}
impl Convert<i64> for f64 {
    fn convert(x: i64) -> Self { x as f64 }
}

impl Convert<f32> for f64 {
    fn convert(x: f32) -> Self { x as f64 }
}

impl Convert<f64> for f64 {
    fn convert(x: f64) -> Self { x }
}
